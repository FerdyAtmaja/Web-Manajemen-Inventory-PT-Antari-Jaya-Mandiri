...
session_start();
 ...
 <head>
    ...
    <!-- Datepicker -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.10.0/js/bootstrap-datepicker.min.js" rel="stylesheet" type="text/css" />
    <!-- Chosen Select -->
 	...
 	<div class="wrapper">
       ...
       <img style="margin-top:-1px;margin-right:5px" src="assets/img/ajm.png" width="48" alt="Logo">
 		...
 		<aside class="main-sidebar">
 			<section style="background-color: #4d4c7d" class="sidebar">
