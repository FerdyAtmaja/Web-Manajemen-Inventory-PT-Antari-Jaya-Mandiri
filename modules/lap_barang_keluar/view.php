					...
					<div class="box-footer">
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button type="submit" class="btn btn-primary btn-social" formaction="modules/lap_barang_keluar/cetakPDF.php">
									<i class="fa fa-file-pdf"></i> Cetak PDF
								</button>

								<button type="submit" class="btn btn-success btn-social" formaction="modules/lap_barang_keluar/exportExcel.php">
			...
			<?php 
				...
				elseif($_GET['alert']==1){
					echo "<div class='alert alert-success alert-dismissable'>
							...
							<h4><i class='icon fa fa-check-circle'></i>Sukses!</h4>Data Produk Keluar berhasil disimpan
						</div>";
				}
			 ?>
