...
<section class="content-header">
	<h1>
		<i class="fa fa-cloud-download icon-title"></i>Data Produk Masuk
				...
				$.ajax({
					...
					success: function(data) {
						$.each(data, function(index, value){
							$('#table-detail-masuk').append('<tr><td>'+value.nama_barang+'</td><td>'+value.jumlah_masuk+'</td><td>'+value.harga+'</td><td>'+value.sub_total+'</td></tr>');
						})
					}
				});
