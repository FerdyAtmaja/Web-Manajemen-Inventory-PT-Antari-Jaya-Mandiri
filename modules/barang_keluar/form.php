...
<?php 
	...
	if($_GET['form']=='add') { ?>
		...
		<section class="content-header">
			<h1>
				<i class="fa fa-edit icon-title"></i>Input Data Produk Keluar
			</h1>
			<ol class="breadcrumb">
				<li><a href="?module=beranda"><i class="fa fa-home"></i>Beranda</a></li>
				<li><a href="?module=barang_keluar">Produk Keluar</a></li>
								...
								<?php 
								 ...
								 <div class="form-group">
								 	...
								 	<div class="col-sm-5">
								 		<select class="chosen-select" id="kd_barang" name="kd_barang" data-placeholder="--Pilih--" autocomplete="off" required>
								 			<option value=""></option>
								 			<?php 
								 				$query_barang = mysqli_query($mysqli, "SELECT kd_barang, nama_barang FROM tb_barang ORDER BY nama_barang ASC") or die('Ada kesalahan pada query tampil produk: '.mysqli_error($mysqli));

								 				while ($data_barang = mysqli_fetch_assoc($query_barang)) {
								 			 ?>
												<option value="<?php echo $data_barang["kd_barang"] ?>"> <?php echo $data_barang["nama_barang"] ?></option>
											<?php } ?>
								 		</select>
								 	</div>
								 </div>
								 ...
								 <span>
								   ...
								   <div class="form-group">
								 	...
								 	<div class="col-sm-5">
								 		<input type="text" class="form-control" id="jumlah_keluar" name="jumlah_keluar" min="0" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required>
								 	</div>
								 </div>
						...
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
									<input type="submit" class="btn btn-success btn-submit pull-right" id="bayar" value="Submit">	
								</div>
							</div>
			 			</div>
