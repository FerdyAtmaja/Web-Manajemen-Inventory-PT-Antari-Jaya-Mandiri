...
<section class="content-header">
	<h1>
		<i class="fa fa-sign-in icon-title"></i>Data Produk Keluar
				...
				$.ajax({
					...
					success: function(data) {
						$.each(data, function(index, value){
							$('#table-detail-keluar').append('<tr><td>'+value.nama_barang+'</td><td>'+value.jumlah_keluar+'</td><td>'+value.harga+'</td><td>'+value.sub_total+'</td></tr>');
						})
					}
				});
