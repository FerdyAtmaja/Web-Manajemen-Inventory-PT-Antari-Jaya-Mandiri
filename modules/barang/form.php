	...
	if ($_GET['form']=='add'){ ?>
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="?module=barang">Produk</a></li>
						...
						<form role="form" class="form-horizontal" action="modules/barang/proses.php?act=insert" method="POST">
							<div class="box-body">
								<?php 
									...
									$query_id=mysqli_query($mysqli, "SELECT RIGHT(kd_barang,6) as kode FROM tb_barang ORDER BY kd_barang DESC LIMIT 1") or die('Ada kesalahan pada query tampil data produk : '.mysqli_error($mysqli));
...
// jika form edit data yg diklik
// isset:cek data ada/tdk
elseif($_GET['form']=='edit'){
	if(isset($_GET['id'])){
		$query=mysqli_query($mysqli, "SELECT * FROM tb_barang a INNER JOIN tb_supplier b ON b.kd_supplier = a.kd_supplier WHERE a.kd_barang='$_GET[id]'") or die ('Ada kesalahan pada query tampil data barang : '.mysqli_error($mysqli));
